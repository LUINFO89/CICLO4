...
// para bootstrap se importa el modal y se busca la ubnicacion donde deseo colocar 
// la ubicacion de los modales o del codigo que deseo re utilizar 
export default function App() { 
  ...
  return (
    ...
    //todo lo que está aquí se verá en el navegador
